...
public class FileDialog extends ListActivity {
	...
	public static final String PATHONLY = "false";
	public static final String LOADSAVE = "LOADSAVE";
	
	private String strPathOnly;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		strPathOnly = getIntent().getStringExtra(PATHONLY);
		selectButton.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				if (selectedFile != null || strPathOnly.equals("true")) {
					if( selectedFile != null ) {
						getIntent().putExtra(RESULT_PATH, selectedFile.getPath());
					}
					getIntent().putExtra(PATH, currentPath);
		...
		if( getIntent().getStringExtra(LOADSAVE).equals("LOAD") )
